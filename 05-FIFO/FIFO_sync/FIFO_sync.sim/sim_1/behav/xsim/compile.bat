...
REM
REM Generated by Vivado on Sun Nov 09 06:06:57 +0200 2025
...
echo "xvlog --incr --relax -prj FIFO_sync_tb_vlog.prj"
call xvlog  --incr --relax -prj FIFO_sync_tb_vlog.prj -log xvlog.log
