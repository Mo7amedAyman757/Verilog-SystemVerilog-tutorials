...
REM
REM Generated by Vivado on Thu Aug 21 14:33:40 +0300 2025
...
echo "xvlog --incr --relax -prj Asynch_counter_tb_vlog.prj"
call xvlog  --incr --relax -prj Asynch_counter_tb_vlog.prj -log xvlog.log
