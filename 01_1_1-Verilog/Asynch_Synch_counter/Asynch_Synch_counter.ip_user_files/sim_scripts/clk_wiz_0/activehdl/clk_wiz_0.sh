...
#
# Script generated by Vivado on Sat Sep 13 16:07:48 +0300 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/IcDesign_Projects/Verilog/Asynch_Synch_counter/Asynch_Synch_counter.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
