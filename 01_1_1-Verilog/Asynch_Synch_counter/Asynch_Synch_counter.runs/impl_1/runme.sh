...
HD_PWD='D:/IcDesign_Projects/Verilog/Asynch_Synch_counter/Asynch_Synch_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Asynch_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Asynch_counter.tcl -notrace
