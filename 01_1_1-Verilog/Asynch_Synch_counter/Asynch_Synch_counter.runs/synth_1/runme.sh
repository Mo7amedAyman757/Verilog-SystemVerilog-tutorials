...
HD_PWD='D:/IcDesign_Projects/Verilog/Asynch_Synch_counter/Asynch_Synch_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Asynch_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Asynch_counter.tcl
