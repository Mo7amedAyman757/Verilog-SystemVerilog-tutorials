...
REM
REM Generated by Vivado on Thu Aug 14 04:35:29 +0300 2025
...
echo "xvlog --incr --relax -prj binary_Mult_vlog.prj"
call xvlog  --incr --relax -prj binary_Mult_vlog.prj -log xvlog.log
