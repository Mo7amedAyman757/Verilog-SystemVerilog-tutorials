...
REM
REM Generated by Vivado on Sun Aug 24 11:29:18 +0300 2025
...
echo "xvlog --incr --relax -prj multi_decade_counter_tb_vlog.prj"
call xvlog  --incr --relax -prj multi_decade_counter_tb_vlog.prj -log xvlog.log
