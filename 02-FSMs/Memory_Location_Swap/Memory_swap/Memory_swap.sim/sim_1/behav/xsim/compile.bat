...
REM
REM Generated by Vivado on Tue Sep 09 22:36:58 +0300 2025
...
echo "xvlog --incr --relax -prj swap_memory_loc_tb_vlog.prj"
call xvlog  --incr --relax -prj swap_memory_loc_tb_vlog.prj -log xvlog.log
