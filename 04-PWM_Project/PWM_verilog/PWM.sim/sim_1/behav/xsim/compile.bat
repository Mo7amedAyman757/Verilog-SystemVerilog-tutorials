...
REM
REM Generated by Vivado on Thu Aug 28 11:31:30 +0300 2025
...
echo "xvlog --incr --relax -prj PWM_Improved_tb_vlog.prj"
call xvlog  --incr --relax -prj PWM_Improved_tb_vlog.prj -log xvlog.log
