...
module enum_tb();
    ...
    //enumeration name cannot start with a number !

    // int(default type); RED = 0, YELLOW = 1, GREEN = 2
    //typedef enum {RED, YELLOW, GREEN} light_1;
    ...
    //enum {RED , YELLOW = 4, GREEN} light_4;
    ...
    typedef enum {RED[4] = 5} color_set_4;
