...
REM
REM Generated by Vivado on Sat Aug 30 14:39:29 +0300 2025
...
echo "xvlog --incr --relax -prj x_101_detector_tb_vlog.prj"
call xvlog  --incr --relax -prj x_101_detector_tb_vlog.prj -log xvlog.log
