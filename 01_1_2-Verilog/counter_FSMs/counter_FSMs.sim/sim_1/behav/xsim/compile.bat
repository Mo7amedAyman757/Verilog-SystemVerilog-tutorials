...
REM
REM Generated by Vivado on Sat Aug 30 16:09:15 +0300 2025
...
echo "xvlog --incr --relax -prj arbitrary_counter_FSMs_tb_vlog.prj"
call xvlog  --incr --relax -prj arbitrary_counter_FSMs_tb_vlog.prj -log xvlog.log
