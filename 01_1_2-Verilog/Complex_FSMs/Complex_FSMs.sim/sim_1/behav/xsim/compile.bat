...
REM
REM Generated by Vivado on Sat Aug 30 15:56:39 +0300 2025
...
echo "xvlog --incr --relax -prj FSMs_2_tb_vlog.prj"
call xvlog  --incr --relax -prj FSMs_2_tb_vlog.prj -log xvlog.log
