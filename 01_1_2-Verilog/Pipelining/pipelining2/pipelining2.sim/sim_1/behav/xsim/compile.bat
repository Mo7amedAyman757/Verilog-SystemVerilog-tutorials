...
REM
REM Generated by Vivado on Tue Mar 10 03:57:03 +0200 2026
...
echo "xvlog --incr --relax -prj pipelining_4stages_tb_vlog.prj"
call xvlog  --incr --relax -prj pipelining_4stages_tb_vlog.prj -log xvlog.log
