...
REM
REM Generated by Vivado on Tue Mar 10 03:16:23 +0200 2026
...
echo "xvlog --incr --relax -prj pipeline_3stage_tb_vlog.prj"
call xvlog  --incr --relax -prj pipeline_3stage_tb_vlog.prj -log xvlog.log
