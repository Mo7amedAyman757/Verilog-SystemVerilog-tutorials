...
REM
REM Generated by Vivado on Sun Aug 24 12:33:10 +0300 2025
...
echo "xvlog --incr --relax -prj timer_parameter_tb_vlog.prj"
call xvlog  --incr --relax -prj timer_parameter_tb_vlog.prj -log xvlog.log
