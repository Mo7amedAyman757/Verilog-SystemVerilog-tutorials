...
REM
REM Generated by Vivado on Thu Aug 21 16:30:17 +0300 2025
...
echo "xvlog --incr --relax -prj mod_counter_parameter_tb_vlog.prj"
call xvlog  --incr --relax -prj mod_counter_parameter_tb_vlog.prj -log xvlog.log
