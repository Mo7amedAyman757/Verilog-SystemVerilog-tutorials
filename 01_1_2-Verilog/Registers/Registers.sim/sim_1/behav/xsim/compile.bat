...
REM
REM Generated by Vivado on Thu Aug 21 12:04:29 +0300 2025
...
echo "xvlog --incr --relax -prj univ_shift_register_tb_vlog.prj"
call xvlog  --incr --relax -prj univ_shift_register_tb_vlog.prj -log xvlog.log
