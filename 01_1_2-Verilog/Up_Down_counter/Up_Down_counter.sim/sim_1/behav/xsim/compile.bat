...
REM
REM Generated by Vivado on Thu Aug 21 15:31:41 +0300 2025
...
echo "xvlog --incr --relax -prj udl_counter_tb_vlog.prj"
call xvlog  --incr --relax -prj udl_counter_tb_vlog.prj -log xvlog.log
