...
HD_PWD='D:/Career tracks/Digial_IC/07-IcDesign_Projects/Verilog/Memory/Memory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synch_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synch_rom.tcl
